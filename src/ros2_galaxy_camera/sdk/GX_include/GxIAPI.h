...
typedef enum GX_FEATURE_ID
{
    ...
    GX_INT_HDR_TARGET_LONG_VALUE            = 14001 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,     ///< Set the target_armor gray value of the long-exposure image.
    GX_INT_HDR_TARGET_SHORT_VALUE           = 14002 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,     ///< Set the target_armor gray value of the short-exposure image.
    GX_INT_HDR_TARGET_MAIN_VALUE            = 14003 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,     ///< Set the target_armor gray value of the HDR image.
